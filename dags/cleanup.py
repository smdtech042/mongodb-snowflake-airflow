...
@dag(
    ...
    schedule="@weekly",  # Staging cleanup can run weekly or after main runs
...
def system_cleanup_dag():
    ...
    def cleanup_local_temp_files():
        ...
        logger.info(
            f"Scanning temp directory: {temp_dir} for temporary export files..."
        )
        ...
        logger.info(
            f"Completed local cleanup. Removed {removed_count} temporary files."
        )
